...
import com.matas.caroperatingsystem.data.model.Distance;
import com.matas.caroperatingsystem.data.model.Duration;
...
public class DirectionHelper {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBGwA9n6QKM_1h-5yXKxYhlkqkUho_CdzE";
    ...
    public DirectionHelper(DirectionHelperListener listener, double originLatitude, double originLongitude, String destination) {
        this.listener = listener;
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        listener.onDirectionHelperSuccess(routes);
    }
